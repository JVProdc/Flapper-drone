...
<br>
  ...
  <p>The batteries are supplied at a 30% state of charge and should be fully charged before their first use. The LED indication on the USB chargers may vary depending on the exact model. Please reach out to us if unsure.</p>
  ...
  <div class="important">
    <p>When charging LiPo batteries, <strong>never leave the charger unattended!</strong></p>
  </div>
  <hr>
  <br>
...
<h2> Pre-flight setup </h2>
  ...
  <div class="info">
    ...
    <p><strong>We always recommend it for novice users.</strong></p>
    <p>Experienced operators can also launch the Flapper from hand, and catch it by hand at the end of the flight. Flying without the landing gear slightly reduces aerodynamic drag, and makes the Flapper a bit more agile in flight due to lower mass and inertia of this configuration.</p>
  </div>
  ...
  <div class="box">
    <p>2. When storing the Flapper in the flight case, remove the landing gear by holding the Flapper at the top and pulling the landing gear down.</p>
  </div>
  ...
  <p>For storage, or when you need to replace a damaged wing, follow these steps to remove the wings:</p>
  ...
  <div class="box">
    <div class="info">
      <p>Before you start with this step, make sure the wing is fully folded.</p>
    </div>
...
<h3>Battery Installation</h3>
  ...
  <div class="info">
    <p>In case you have purchased the Flapper with the optional shells, these are detached from the Flapper when stored in the flight case. The shells are only for aesthetic purposes and the Flapper can be operated without them, e.g. when larger payload capacity is desired or when performing tests which involve higher risk of crashing.</p>
  </div>
  ...
  <div class="box">
    <p>14. The shells are installed! You can go ahead and <a href="wing-installation">install the wings</a>.</p>
  </div>

  <h3>Body shell removal</h3>

  <div class="info">
    <p>To remove the shells, follow the installation steps in reverse.</p>
  </div>
